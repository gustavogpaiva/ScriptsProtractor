...
var delivery = function () {
    ...
    this.geral = async function(modoDLV, clienteDLV, precoMinPed, codLojaEsitef, vendedor, validaDLV){
        ...
        h.pesquisaItem('NMRAZSOCCLIE', clienteDLV);
        ...
        h.pesquisaItem('NMRAZSOCVEN', vendedor);
    ...
    this.unidade = async function(clientePadrao, vendedor, tempoEntregaLim, taxaEntrega, precoMinPed, distancia){
        h.navegar('Unidade');
        z.widget.grid.click('NMFILIAL', j.getValor('filial'), '1342490609174259265917');
        h.navegar('Parâmetros');
        z.component.footer.clickCenterActionByIcon('pencil');

        h.pesquisaItem('NMRAZSOCCLIE', clientePadrao);
        h.pesquisaItem('NMFANVEN', vendedor);
    ...
    this.deliveryTempo = async function(unidade, loja, tempoEntrega, tempoProducao){
        h.navegar('Unidade');
        z.widget.grid.click('NMFILIAL', unidade, '1342490609174259265917');
        h.navegar('Loja');
