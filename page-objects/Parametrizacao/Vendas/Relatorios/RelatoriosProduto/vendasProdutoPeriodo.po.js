...
class vendasProdutoPeriodo {
    ...
    /**
     * Seleciona um tipo de seleção de produto no filtro.
     * 
     * @example 
     *   selecionarTipoSelecao('Nivel');
     * 
     * @param {String} tipoSelec - Nome do tipo de seleção de produto a ser selecionado.    
     */
     ...
     *   definirNivel(1);
     * 
     * @param {Number} nivel - Número do nivel de produto a ser selecionado.    
     */
    definirNivel(nivel) {
