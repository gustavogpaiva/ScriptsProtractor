...
class movProdHora {
     ...
     * 
     * @example 
     *   selecionarTipoRelatorio('Quantidade');
     * 
     * @param {String} tipoRel - Descrição do tipo de relatório a ser selecionado.    
     */
    selecionarTipoRelatorio(tipoRel) {
        z.field.selectNative.click('IDTPRELATORIO', tipoRel);
    };
...
module.exports = new movProdHora();