...
class cancelamentoItens {
    ...
    selecionarSituacao(...situacao) {
        //Seleciona um vendedor no filtro
        let fieldName = 'IDPRODPRODUZC';
        let columnName = 'DSPRODPRODUZC';

        z.field.selectMultiple.click(fieldName, columnName, situacao);
    };
