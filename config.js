...
exports.config = {
    ...
    specs: [
        'specs/Parametrizacao/Vendas/Relatorios/RelatoriosDayPart/vendasDayPart.spec.js'
    ],
    suites: {
        //parceiro
        ...
        promocaoCombinada: ['specs/Parametrizacao/Vendas/Relatorios/RelatoriosVenda/promocaoCombinada.spec.js'],
